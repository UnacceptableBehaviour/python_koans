...
class AboutInheritance(Koan):
    class Dog:
        ...
        @property                   # shortcut for creating readonly properties
        def name(self):
            return self._name
    ...
    def test_subclasses_have_the_parent_as_an_ancestor(self):
        print(self.Dog.mro())       # [<class 'koans.about_inheritance.AboutInheritance.Dog'>, <class 'object'>]
        print(self.Chihuahua.mro()) # [<class 'koans.about_inheritance.AboutInheritance.Chihuahua'>, <class 'koans.about_inheritance.AboutInheritance.Dog'>, <class 'object'>]
    ...
    def test_subclasses_add_new_behavior(self):
        ...
        fido = self.Dog("Fido")
        with self.assertRaises(AttributeError): fido.wag()      # TODO - syntax for Exceptions
