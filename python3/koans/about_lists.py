...
class AboutLists(Koan):
    ...
    def test_list_literals(self):
        ...
        nums[0:] = [1]                                      # [0:5:6] start:stop:step
...
# a[::-1]            # step backward
    ...
    def test_lists_and_ranges(self):
        ...
        #self.assertEqual([1, 2, 3, 4, 5], range(1,6))   # WHY FAIL? <TODO      console disagrees!
        # >>> range(1,6)    
        # [1, 2, 3, 4, 5]
        # >>> type(range(1,6))
        # <type 'list'>
        self.assertEqual([0, 1, 2, 3, 4], list(range(5)))   # [0, 1, 2, 3, 4]
        self.assertEqual([5,6,7,8], list(range(5, 9)))      # same as slices
    ...
    def test_insertions(self):
        ...
        knight.insert(2, 'not')
        self.assertEqual(['you', 'shall', 'not','pass'], knight) # insert @ 2

        knight.insert(0, 'Arthur')
        self.assertEqual(['Arthur', 'you', 'shall', 'not','pass'], knight) # insert @ 0
