...
class AboutMethods(Koan):
    ...
    def test_functions_without_self_arg_are_global_functions(self):
        ...
        #self.assertEqual(7, self.function_with_the_same_name(3,4)) # PASS
        #                    ^ ^ ^
    ...
    def method_with_documentation(self):
        "A string placed at the beginning of a function is used for documentation"  # < < DOCUMENTATION
        return "ok"
    

    def test_the_documentation_can_be_viewed_with_the_doc_method(self):
        # print documentation
        # help(self.method_with_documentation)
        self.assertRegex(self.method_with_documentation.__doc__, r'function is used for documentation')
